...
O serviço acompanha downloads e a biblioteca a cada cinco minutos. A consulta de novos lançamentos ocorre quando um cliente chama `GET /checagem_diaria`. A API local usa a porta `8768`.
